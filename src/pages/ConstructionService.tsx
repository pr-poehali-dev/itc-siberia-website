...
const ConstructionService = () => {
  ...
  const applications = [
    ...
    { icon: 'Waypoints', text: 'Мосты, эстакады, путепроводы' },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <PageHero
        title="Строительные металлоконструкции – основа современных, прочных и быстровозводимых зданий"
      />

      <BackLink currentLabel="Строительные металлоконструкции" />
