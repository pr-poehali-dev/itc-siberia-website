...
const MetalProcessing = () => {
  const services = [
    ...
    },
    {
      ...
      image: 'https://cdn.poehali.dev/files/fff7c4c5-a0ab-4629-b155-bec70fdf28e3.jpg',
      specs: [
    ...
    },
    {
      ...
      image: 'https://cdn.poehali.dev/files/d9ec9027-f4d9-4fb1-baae-95e2d089266d.jpg',
      specs: [
  ...
  const advantages = [
    ...
    'Собственные мощности – современные производственные цеха оснащенные современными станками с ЧПУ',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <BackLink currentLabel="Обработка металла" />
