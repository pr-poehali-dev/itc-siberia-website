    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <LegalSection title="4. Согласие на использование cookie">
          ...
          <p>
            Пользователь вправе отказаться от необязательных cookie, нажав соответствующую кнопку
            в уведомлении. В этом случае будут использоваться только технические cookie, без
            которых работа сайта невозможна.
          </p>
        </LegalSection>
