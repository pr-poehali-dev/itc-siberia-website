...
const TechnologicalService = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <PageHero
        title="Технологические металлоконструкции – точность, надежность и адаптация под ваши производственные задачи"
      />

      <BackLink currentLabel="Технологические металлоконструкции" />
